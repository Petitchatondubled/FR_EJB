...
public class NiveauQualification implements Serializable {
	...
	@Id
	@SequenceGenerator(name="NIVEAU_QUALIFICATION_INTITULE_GENERATOR", sequenceName="NIVEAU_QUALIFICATION_INTITULE_SEQ")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="NIVEAU_QUALIFICATION_INTITULE_GENERATOR")
